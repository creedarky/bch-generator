module.exports = function ( grunt ) {
  ...
  var taskConfig = {
    ...
    stylus: {
      build: {
        files: {
          '<%= build_dir %>/assets/<%= pkg.name %>--<%= pkg.version %>.css': ['<%= app_files.stylus_folder %>'+'*.styl','<%= app_files.stylus_vendor_folders %>'+'*.styl'] // compile and concat into single file
        }
      },
      compile: {
        options:true,
